...
export const CAFE_INFO: CafeInfo = {
  ...
  naverMapUrl: "https://naver.me/5T4FC8SF",
  googleMapUrl: "https://maps.app.goo.gl/shPP2PDePZF2zgZm9"
};
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // Fixed id: 17 - removed duplicate description and added missing image property
